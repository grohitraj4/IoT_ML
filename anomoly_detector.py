RoomLightMonitor_using_z-score_analysis

Step 1: Under Module 1, 'Building your first IoT sensor project' topic, we had learned how to connect an LDR to the Bolt and monitor it over the Cloud. Make the same circuit connections as per that topic. You can click here to go back to that topic.
